...
variable "master_instance_type" { default = "t1.micro" }
variable "workers" { default = "2" }
variable "worker_instance_type" { default = "t1.micro" }
...
variable "etcd_discovery_url_file" { default = "etcd_discovery_url_file" }
variable "domain_name" { default = "foo.tv" }
